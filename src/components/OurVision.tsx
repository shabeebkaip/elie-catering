        ...
        <div className="container-custom px-6 md:px-14 lg:px-20 relative z-10">
          <div className="relative grid grid-cols-1 lg:grid-cols-[380px_1fr] gap-0 lg:min-h-[1120px]">
            <div className="relative hidden lg:block">
              ...
              <motion.div initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 1.0, delay: 0.08 }} className="absolute top-[5%] left-[7%] z-20">
                <div className="relative w-[190px] h-[565px] overflow-hidden border-[6px] border-accent/35 shadow-[0_50px_100px_rgba(0,0,0,0.38)]" style={{ borderRadius: "9999px 9999px 64px 64px" }}>
              ...
              <motion.div initial={{ opacity: 0, scale: 0.88, y: 30 }} whileInView={{ opacity: 1, scale: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.9, delay: 0.26 }} className="absolute top-[37%] left-[50%] z-10">
                <div className="relative w-[152px] h-[435px] overflow-hidden border-[8px] border-accent shadow-[0_40px_80px_rgba(0,0,0,0.45)]" style={{ borderRadius: "9999px 9999px 56px 56px" }}>
              ...
              <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, delay: 0.42 }} className="absolute bottom-[5%] left-[4%] z-30">
                <div className="relative w-[104px] h-[268px] overflow-hidden border-4 border-white/16 shadow-xl" style={{ borderRadius: "9999px 9999px 44px 44px", transform: "rotate(7deg)" }}>
              ...
              <div className="absolute top-[17%] right-[5%] w-[60px] h-[160px] border border-accent/14" style={{ borderRadius: "9999px 9999px 30px 30px", transform: "rotate(-14deg)" }} />
            </div>
            ...
            <div className="relative pt-16 md:pt-20 lg:pt-24 pb-20 md:pb-28">
              <div className="pb-16 md:pb-20 lg:pb-24 border-b border-accent/12">
                <motion.div {...fadeUp(0.06)}>
                  <div className="flex items-center gap-3 mb-5">
                    ...
                    <span className="text-[9px] tracking-[0.42em] uppercase text-cream/38 font-bold">{t("eyebrow")}</span>
                  </div>
                </motion.div>
                ...
                <motion.div {...fadeUp(0.21)} className="mt-8 md:mt-10 space-y-5 max-w-[520px]">
                  <p className="text-[clamp(15px,1.6vw,17px)] leading-relaxed text-cream/75 font-light">{t("p1")}</p>
                  <p className="text-[clamp(15px,1.6vw,17px)] leading-relaxed text-cream/52 font-light">{t("p2")}</p>
                </motion.div>
              </div>

              <motion.div initial={{ opacity: 0, scaleX: 0 }} whileInView={{ opacity: 1, scaleX: 1 }} viewport={{ once: true }} transition={{ duration: 0.65, delay: 0.08 }} className="py-8 md:py-10 flex items-center gap-4 origin-left">
              ...
              <div className="pb-4">
                <motion.div {...fadeUp(0.06)}>
                  <div className="flex items-center gap-3 mb-5">
                    <div className="w-5 h-px bg-accent/40 mx-1" />
                    <span className="text-[9px] tracking-[0.42em] uppercase text-cream/38 font-bold">{t("missionEyebrow")}</span>
                  </div>
                </motion.div>
                ...
                <motion.div {...fadeUp(0.21)} className="mt-8 md:mt-10 space-y-5 max-w-[520px]">
                  ...
                  <p className="text-[clamp(15px,1.6vw,17px)] leading-relaxed text-cream/52 font-light">{t("missionP2")}</p>
                </motion.div>

                <motion.div {...fadeUp(0.3)} className="mt-10 md:mt-12">
                  <a href="#services" className="inline-flex items-center gap-3 px-8 py-4 rounded-full text-[10px] tracking-[0.26em] uppercase font-bold border border-accent/40 text-accent no-underline transition-all duration-300 hover:bg-accent hover:text-primary hover:border-accent hover:scale-[1.04] active:scale-95">

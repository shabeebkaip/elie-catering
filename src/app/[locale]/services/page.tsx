...
/* ── Shared gradient ───────────────────────────────────────────── */
const GRAD_UP = "linear-gradient(to top, rgba(5,5,5,0.98) 0%, rgba(5,5,5,0.62) 42%, rgba(5,5,5,0.08) 75%, transparent 100%)";
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 pointer-events-none" style={{ zIndex: 0 }}>
        <Image
          src="/images/about/marble.webp"
          alt=""
          fill
          className="object-cover"
          priority
        />
        {/* Deep dark overlay — marble shows through at ~8% */}
      ...
      <main className="overflow-x-hidden" style={{ background: "transparent" }}>
        ...
        <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden px-6">
          {/* Section-local atmospheric image (sits above fixed marble) */}
          ...
          <div className="relative z-10 text-center max-w-5xl mx-auto pt-28">
            ...
            >
              ...
              <span
                className="text-[9px] tracking-[0.45em] uppercase font-bold"
                style={{ color: `rgba(201,161,91,0.75)` }}
              >
            ...
            <motion.p
              ...
              style={{ fontSize: "clamp(14px, 1.5vw, 17px)", color: `rgba(245,241,232,0.46)`, maxWidth: "400px", lineHeight: 1.85 }}
            >
              {isAr
          ...
          <div className="absolute bottom-9 left-1/2 -translate-x-1/2">
            <div className="w-px h-10" style={{ background: `linear-gradient(to bottom, rgba(201,161,91,0.35), transparent)` }} />
          </div>
        </section>
              ...
              {BENTO.map((card, i) => (
                ...
                >
                  <Link
                    ...
                    style={{
                      height: i < 2 ? "clamp(380px, 50vh, 520px)" : "clamp(320px, 42vh, 440px)",
                      outline: `1px solid rgba(201,161,91,0.1)`,
                    }}
                  >
                    {/* Image */}
                    <Image
                    ...
                    {/* Gradient */}
                    <div className="absolute inset-0" style={{ background: GRAD_UP }} />

                    {/* Gold border reveal */}
                    <div
                      className="absolute inset-0 rounded-2xl border border-transparent transition-colors duration-500 pointer-events-none group-hover:border-[rgba(201,161,91,0.28)]"
                    />

                    {/* Content */}
                    <div className="relative z-10 flex flex-col justify-end p-7 md:p-8 w-full">
                      {/* Num · eyebrow */}
                      <p
                        className="text-[8.5px] tracking-[0.42em] uppercase font-bold mb-3"
                        style={{ color: `rgba(201,161,91,0.56)` }}
                      >
                        {card.num} · {isAr ? card.eyebrowAr : card.eyebrow}
                      </p>

                      {/* Title */}
                      <h3
                        className="font-serif font-light leading-[0.9] mb-2 transition-colors duration-300 group-hover:opacity-90"
                        style={{
                          fontSize: i < 2 ? "clamp(28px, 3.2vw, 44px)" : "clamp(24px, 2.6vw, 36px)",
                          color: CREAM,
                      ...
                      <p
                        ...
                        style={{ fontSize: "12.5px", color: "rgba(245,241,232,0.42)", maxWidth: "320px" }}
                      >
                        {isAr ? card.descAr : card.desc}
                      </p>

                      {/* Explore — reveals on hover */}
                      <div className="opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300">
                        <span
                          className="inline-flex items-center gap-2 text-[9.5px] tracking-[0.26em] uppercase font-bold"
                          style={{ color: GOLD }}
                        >
        ...
        <section className="px-4 md:px-7 xl:px-10 py-20 md:py-28">
          <div className="max-w-[1480px] mx-auto">
            ...
            >
              ...
              >
                {isAr
                  ? <>لماذا يختار عملاؤنا <span style={{ color: GOLD }}>إيلي.</span></>
                  : <>Why clients choose <em className="italic" style={{ color: GOLD }}>Elie.</em></>}
              </h2>
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
              {WHY.map((w, i) => (
                ...
                >
                  {/* Roman numeral */}
                  <span
                    className="font-serif font-light block mb-5 leading-none"
                    style={{ fontSize: "36px", color: `rgba(201,161,91,0.25)` }}
                  >
                    {w.num}
                  </span>
                  ...
                  {/* Thin gold rule */}
                  <div className="w-8 h-px mb-4" style={{ background: `rgba(201,161,91,0.3)` }} />

                  {/* Desc */}
                  <p
                    className="leading-relaxed"
                    style={{ fontSize: "13px", color: "rgba(245,241,232,0.44)" }}
                  >
                ...
                >
                  ...
                  >
                    ...
                    <div className="relative z-10 flex flex-col justify-end p-7 md:p-8 w-full">
                      {/* Index */}
                      <p
                        className="text-[9px] tracking-[0.4em] uppercase font-bold mb-4"
                      ...
                      {/* Title */}
                      <h3
                        className="font-serif font-light leading-tight mb-3 transition-colors duration-300 group-hover:opacity-90"
                        style={{
                      ...
                      <p
                        className="leading-relaxed mb-5"
                        style={{ fontSize: "12.5px", color: "rgba(245,241,232,0.42)" }}
                      >
        ...
        >
          {/* Dark veil over marble for this section */}
          ...
          <div className="relative z-10 max-w-3xl mx-auto text-center">
            ...
            >
              ...
              <motion.div
                ...
                style={{
                  width: "68px", height: "1px", transformOrigin: "center",
              ...
              <p
                ...
                style={{ fontSize: "clamp(13.5px, 1.4vw, 16px)", color: "rgba(245,241,232,0.38)", maxWidth: "400px" }}
              >
                {isAr

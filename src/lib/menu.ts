...
export const menuCategories: MenuCategory[] = [
  ...
  },
  {
    ...
    gallery: [
      "/menu/bbq-live-station-1.webp",
      "/menu/bbq-live-station-2.webp",
      "/menu/shawarma-station.webp",
      "/menu/bbq-burger-station.webp",
    ],
  },
  {
    slug: "bbq-section",
  ...
  },
  {
    ...
    gallery: [
      "/menu/buffet-international-1.webp",
      "/menu/buffet-international-2.webp",
      "/menu/saudi-cuisine.webp",
      "/menu/traditional-buffet-en.webp",
      "/menu/sample-buffet-1.webp",
      "/menu/sample-buffet-2.webp",
    ],
  },
  {
    slug: "seafood-sushi",
